...
console.log("SERVER BOOT: API KEY IS", process.env.GEMINI_API_KEY ? "SET" : "MISSING", "LENGTH:", process.env.GEMINI_API_KEY?.length);
...
// Use a fixed UUID for the demo user so server restarts don't break existing sessions
...
let db = {
  ...
  candidates: [
    ...
    },
    {
      ...
      userId: demoUserId,
      name: 'Priya Patel',
      email: 'priya.devops@example.com',
      technology: 'Go',
  ...
  jobs: [
    {
      ...
      description: 'Looking for a Senior Frontend Engineer with 5+ years of experience. Must have deep knowledge of React, Node.js, and modern CSS architectures. TypeScript experience is highly desirable.',
      source: 'Galaxy API Integration',
      createdAt: new Date().toISOString()
    },
    {
      id: uuidv4(),
      ...
      location: 'Remote',
      description: 'Seeking an architect to redesign our core platform. Required skills: React, TypeScript, Node.js, GraphQL. You will be responsible for technical decisions and mentoring junior devs.',
      source: 'Excel Upload',
    ...
    },
    {
      ...
      company: 'DataDyne',
      location: 'Toronto, ON',
      description: 'Join our data team to build robust APIs using FastAPI and Python. Experience with AWS and containerization is required. 3+ years experience.',
      source: 'Manual Entry',
    ...
    },
    {
      ...
      location: 'Seattle, WA',
      description: 'We are looking for an ML Engineer to build scalable NLP models. Required: Python, TensorFlow or PyTorch, and 4+ years of industry experience. Big data experience (Spark) is a plus.',
      source: 'Galaxy API Integration',
    ...
    },
    {
      ...
      company: 'CloudWorks',
      location: 'Remote',
      description: 'Critical role ensuring uptime of our global services. Must have hands-on experience with production Kubernetes clusters, Terraform, AWS, and strong Go or Python scripting skills.',
      source: 'Excel Upload',
    ...
    },
    {
      ...
      description: 'Seeking a seasoned Java Architect to lead our transaction processing systems. Must be an expert in Java, Spring Boot, event-driven architectures (Kafka), and highly concurrent systems.',
      source: 'Galaxy API Integration',
    ...
    },
    {
      id: uuidv4(),
      userId: demoUserId,
      title: 'Junior/Mid Full-Stack Node Developer',
      company: 'StartupX',
      location: 'Austin, TX',
      description: 'Fast-paced startup environment. Need a dev who can jump between React frontend and Node/Express backend. MongoDB experience required. 2+ years experience preferred.',
      source: 'Manual Entry',
    ...
    },
    {
      ...
      company: 'AppSynergy',
      location: 'Remote',
      description: 'Help us build our cross-platform mobile app. Need strong React Native skills, state management, and an eye for UI/UX detail. Swift/Kotlin bridges experience is nice to have.',
      source: 'Galaxy API Integration',
    ...
    },
    {
      ...
      description: 'We are migrating from legacy to Vue 3. Need a Vue developer with strong CSS/Tailwind skills to build beautiful, responsive web applications.',
      source: 'Excel Upload',
    ...
    },
    {
      ...
      location: 'San Francisco, CA',
      description: 'Building data pipelines using Python, SQL, and Airflow. Cloud data warehouse experience (Snowflake/Redshift) required.',
      source: 'Galaxy API Integration',
...
db.applications = [
  ...
  },
  {
    id: uuidv4(),
    userId: demoUserId,
    candidateId: db.candidates[1].id,
    jobId: db.jobs[1].id,
    status: 'UNDER REVIEW',
    createdAt: new Date(Date.now() - 86400000).toISOString()
  }
